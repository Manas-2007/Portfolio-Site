  ...
  const statsData = [
    {
      id: 1,
      icon: (
        <FaFileCode className="text-[26px] lg:text-[40px] text-blue-500 drop-shadow-[0_0_20px_rgba(59,130,246,0.9)]" />
      ),
      value: "10",
    ...
    },
    {
      id: 2,
      icon: (
        <FiActivity className="text-[26px] lg:text-[40px] text-purple-400 drop-shadow-[0_0_20px_rgba(168,85,247,0.9)]" />
      ),
      value: "3",
    ...
    },
    {
      id: 3,
      icon: (
        <FiCoffee className="text-[26px] lg:text-[40px] text-fuchsia-500 drop-shadow-[0_0_20px_rgba(217,70,239,0.9)]" />
      ),
      value: "350+",
      label: "Code Commits",
    ...
    },
    {
      id: 4,
      icon: (
        <FaRocket className="text-[26px] lg:text-[40px] text-indigo-400 drop-shadow-[0_0_20px_rgba(129,140,248,0.9)]" />
      ),
      value: "60+",
      label: "GFG Problems",
      borderClasses: "",
      ...
      >
        <div className="absolute inset-0 p-[2px] rounded-2xl overflow-hidden -z-10">
          <div
            style={{
              ...
              background:
                "conic-gradient(from 0deg, #3b82f6, #a855f7, #d946ef, #3b82f6)",
            }}
        ...
        <div className="relative bg-[#0d1018]/95 backdrop-blur-xl rounded-2xl overflow-hidden w-full h-full p-px">
          <div
            style={{
              background:
                "linear-gradient(270deg, rgba(59,130,246,0.1), rgba(168,85,247,0.1), rgba(217,70,239,0.1))",
          ...
          <div className="relative z-10 grid grid-cols-2 lg:grid-cols-4 w-full h-full">
            {statsData.map((stat) => (
              ...
              >
                ...
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${stat.hoverColor} opacity-0 group-hover/stat:opacity-100 transition-all duration-500 z-0`}
                ></div>
                ...
                <div className="relative z-10 flex items-center justify-center gap-3 lg:gap-4 w-full max-w-[200px] mx-auto">
                  ...
                  <div className="flex flex-col text-left">
                    <h4
                      className={`text-[23px] lg:text-[29px] font-bold tracking-tight mb-0.5 leading-none text-transparent bg-clip-text bg-gradient-to-r ${stat.textColor} drop-shadow-[0_2px_10px_rgba(255,255,255,0.2)]`}
                    >
                      {stat.value}
                    </h4>
