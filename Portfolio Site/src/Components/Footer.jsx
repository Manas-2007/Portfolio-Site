...
const Footer = () => {
  ...
  const contactInfo = [
    { icon: <FiMail />, text: "manas@example.com", link: "mailto:manas@example.com" },
    { icon: <FiPhone />, text: "+91 12345 67890", link: "tel:+911234567890" },
    { icon: <FiMapPin />, text: "Mumbai, India", link: "#" },
    { icon: <FiLinkedin />, text: "linkedin.com/in/manas", link: "https://linkedin.com" },
    { icon: <FiGithub />, text: "github.com/manas", link: "https://github.com" },
  ];

  return (
    <footer className="relative bg-[#0a0d14] border-t border-white/5 pt-12 lg:pt-10 pb-6 overflow-hidden z-10">
      
      {/* Custom CSS Animation for the 8x8 Grid Scanner */}
      <style>
        {`
          @keyframes scan {
            0% { top: 0%; opacity: 0; }
      ...
      <div className="w-full max-w-[1300px] mx-auto px-6 md:px-12 lg:px-20 xl:px-28">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-6 mb-10">
          ...
          <div className="flex flex-col items-start text-left pr-0 lg:pr-8 sm:col-span-2 lg:col-span-1">
            {/* Badge with animated glowing dot */}
          <div className="flex items-center gap-2 lg:gap-3 mb-3">
            ...
            >
              ...
              {/* Shimmer is ON by default on mobile, hidden on lg screens unless hovered */}
              ...
              <span className="relative flex items-center gap-2 z-10">
                Get In Touch
                {/* Arrow is slightly shifted by default on mobile, shift on hover for desktop */}
          ...
          {/* ======================================= */}
          {/* MIDDLE COLUMN: Contact List (GRID ON MOBILE) */}
          {/* ======================================= */}
          <div className="grid grid-cols-2 lg:flex lg:flex-col gap-y-4 gap-x-3 pt-4 lg:pt-2 sm:col-span-1">
            {contactInfo.map((info, index) => (
              <a 
                ...
                rel="noreferrer"
                // min-w-0 added to parent to allow truncate to work properly in CSS Grid
              ...
              >
                ...
                {/* Truncate added so long emails don't break the 2-column mobile layout */}
          ...
          {/* ======================================= */}
          <div className="flex items-center justify-center relative min-h-[150px] sm:col-span-1 pt-6 lg:pt-0">
            
            <div className="relative w-[140px] h-[140px]">
              <div className="grid grid-cols-8 gap-3 w-full h-full">
                {[...Array(64)].map((_, i) => (
                  <div key={i} className="w-1.5 h-1.5 rounded-full bg-white/10 hover:bg-cyan-400 transition-colors duration-300"></div>
                ))}
              </div>
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <div className="px-3 py-1 bg-[#0a0d14]/90 backdrop-blur-md border border-cyan-500/30 rounded text-cyan-300 text-[10px] font-bold tracking-widest shadow-[0_0_20px_rgba(34,211,238,0.2)]">
                  INDIA
                </div>
              </div>
            </div>
