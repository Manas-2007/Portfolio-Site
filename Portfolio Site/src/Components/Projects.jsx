...
// Extracted Card Component to handle individual slider state
const ProjectCard = ({ project, index, totalProjects }) => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);

  // Auto-slider effect: Changes image every 3.5 seconds
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      >
        <div className={`w-full h-full transition-transform duration-700 group-hover:scale-105 ${project.placeholderBg}`}>
          {/* Images mapping */}
      ...
      <div className="relative z-10 flex flex-col flex-grow p-5">
        ...
        <h3 className="text-white font-semibold text-[17px] md:text-[18px] tracking-wide mb-2.5 group-hover:text-purple-400 transition-colors duration-300">
          <a href={project.liveLink} target={project.liveLink !== "#" ? "_blank" : "_self"} rel="noreferrer">
            {project.title}
          </a>
        </h3>
        ...
        >
          ...
          <span>{project.liveLink !== "#" ? "View Project" : "In Development"}</span>
          <FiArrowRight
            size={14}
  ...
  const projectsData = [
    {
      ...
      description: "A Full-Stack platform connecting households with waste collectors to promote a circular economy. Features role-based auth and secure JWT cookies.",
      ...
      images: [
        "P1_1.jpg", 
        "/YOUR_IMG_PATH_HERE/recircle_2.jpg",     
        "/YOUR_IMG_PATH_HERE/recircle_3.jpg"      
      ]
    },
    {
      id: 2,
      title: "TradeBridge Financial Network",
      description: "An advanced paper-trading platform with real-time WebSocket charts. It features an intelligent algorithm that automatically detects and highlights candlestick patterns to assist user decisions.",
      techStack: ["React", "Tailwind", "WebSockets", "Trading APIs", "Vite"],
      placeholderBg: "bg-gradient-to-br from-[#2563eb] to-[#1e3a8a]",
      liveLink: "#", // Jab live ho jaye tab link daal dena
      statusBadge: "In Development", // Ya "Live" kar dena jab complete ho jaye
      images: [
        "/YOUR_IMG_PATH_HERE/tradebridge_thumb.jpg", 
        "/YOUR_IMG_PATH_HERE/tradebridge_2.jpg",
        "/YOUR_IMG_PATH_HERE/tradebridge_3.jpg"
      ]
    },
    {
      id: 3,
      title: "LifeBridge Health Network",
      description: "A centralized MERN ecosystem bridging patients with registered blood donors. Patients can broadcast urgent requirements, enabling direct acceptance and hospital donations.",
      ...
      statusBadge: "Live",
      images: [
        "/YOUR_IMG_PATH_HERE/lifebridge_thumb.jpg", 
        "/YOUR_IMG_PATH_HERE/lifebridge_2.jpg",
        "/YOUR_IMG_PATH_HERE/lifebridge_3.jpg"
      ]
    }
  ];
