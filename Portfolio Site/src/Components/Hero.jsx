...
import { FadeUp, PopIn, MagneticHover } from './Animations';
  ...
  return (
    ...
    <div className="w-full lg:flex-1 flex flex-col items-center lg:items-start text-center lg:text-left justify-center relative z-10 gap-6 lg:max-w-[600px]" data-aos="fade-right">
          ...
          <AnimatedHeading 
            ...
            className="text-4xl sm:text-5xl md:text-6xl lg:text-[54px] font-bold justify-center lg:justify-start" 
          />
         ...
         {/* Action Buttons */}
          <FadeUp delay={0.5} className="flex flex-col sm:flex-row items-center gap-4 mt-4 w-full sm:w-auto">
            ...
            <MagneticHover>
              <a href="#projects" className="group relative flex items-center justify-center w-full sm:w-auto gap-2 px-8 py-3 rounded-xl font-semibold text-sm text-white overflow-hidden shadow-[0_0_15px_rgba(168,85,247,0.3)] hover:shadow-[0_0_25px_rgba(34,211,238,0.4)] transition-all duration-300">
            ...
            {/* Contact Button wrapped in MagneticHover */}
            <MagneticHover>
              <a href="#contact" className="group relative flex items-center justify-center w-full sm:w-auto gap-2 px-8 py-3 rounded-xl font-semibold text-sm text-white bg-black/20 hover:bg-black/40 border border-transparent transition-all duration-300 shadow-[0_0_10px_rgba(255,255,255,0.05)]">
          ...
          <FadeUp delay={0.7} className="flex items-center justify-center lg:justify-start gap-6 mt-6 w-full">
            {[
              ...
              <MagneticHover key={index}>
                <a href={social.link} target="_blank" rel="noreferrer" className="w-11 h-11 flex items-center justify-center rounded-full transition-all duration-300 border text-cyan-400 border-cyan-400 shadow-[0_0_10px_rgba(34,211,238,0.4)] hover:text-purple-400 hover:border-purple-400 hover:shadow-[0_0_20px_rgba(168,85,247,0.6)]">
                  {social.icon}
                </a>
              </MagneticHover>
            ))}
        ...
        {/* RIGHT COLUMN - IMAGE & GRAPHICS (Using PopIn for 3D reveal) */}
        <PopIn delay={0.4} className="w-full lg:flex-1 relative flex items-center justify-center lg:justify-end min-h-[350px] sm:min-h-[400px] lg:min-h-[500px] z-10 mt-8 lg:mt-0">
          ...
          {/* Profile Image */}
          <img src="/profile.jpg" alt="Manas" className="relative z-10 w-full max-w-[300px] sm:max-w-[340px] md:max-w-[380px] lg:max-w-[460px] h-auto object-contain drop-shadow-[0_0_15px_rgba(168,85,247,0.4)]" />
